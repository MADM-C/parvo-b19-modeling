...
plot(owsa_results$owsa_B19_Deaths) +
  ...
  labs(colour = "Strategy") +
  theme_grey(base_size = 10) +
  geom_vline (data = filter(owsa_test, parameter == "Proportion Immune"), aes(xintercept = v_det)) +
  geom_vline (data = filter(owsa_test, parameter == "Infection Probability"), aes(xintercept = v_inf)) +
  geom_vline (data = filter(owsa_test, parameter == "Detection Probability with Increased Surveillance"), aes(xintercept = v_det))
