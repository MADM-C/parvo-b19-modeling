...
## Load model
source("b19_phase2_model_function.R")
...
ggsave(path = "Phase 2 Plots", filename = "heat_deaths_ii.png")
...
ggsave(path = "Phase 2 Plots", filename = "heat_transfusions_ii.png")
...
ggsave(path = "Phase 2 Plots", filename = "heat_deaths_id.png")
...
ggsave(path = "Phase 2 Plots", filename = "heat_transfusions_id.png")
...
ggsave(path = "Phase 2 Plots", filename = "heat_deaths_di.png")
...
ggsave(path = "Phase 2 Plots", filename = "heat_transfusions_di.png")
...
ggsave(path = "Phase 2 Plots", filename = "heat_deaths_dt.png")
...
ggsave(path = "Phase 2 Plots", filename = "heat_transfusions_dt.png")
...
ggsave(path = "Phase 2 Plots", filename = "heat_deaths_ds.png")
...
ggsave(path = "Phase 2 Plots", filename = "heat_transfusions_ds.png")
