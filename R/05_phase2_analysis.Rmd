...
v_names_str <- c("Status Quo", "Increasing Detection")
n_str <- length(v_names_str)

## Load model
source("R/02_phase2_model_functions.R")
  ...
  mutate(parameter = ifelse(parameter == "p_imm", 
                            ...
                            ifelse(parameter == "p_inf", 
                                   ...
                                   ifelse(parameter == "p_det_surv", 
                                          "Detection Probability with Increased Surveillance",
...
plot(owsa_results$owsa_B19_Deaths) +
  ...
  labs(colour = "Strategy") +
  theme_bw() +
  geom_vline (data = filter(owsa_test, parameter == "Proportion Immune"), aes(xintercept = v_det), linetype = "dotted") +
  geom_vline (data = filter(owsa_test, parameter == "Infection Probability"), aes(xintercept = v_inf), linetype = "dotted") +
  geom_vline (data = filter(owsa_test, parameter == "Detection Probability with Increased Surveillance"), aes(xintercept = v_det), linetype = "dotted")

ggsave(path = "results/Phase 2 Plots", filename = "one-wayplot.png")
...
ggsave(path = "results/Phase 2 Plots", filename = "heat_deaths_ii.png")
...
ggsave(path = "results/Phase 2 Plots", filename = "heat_transfusions_ii.png")
...
ggsave(path = "results/Phase 2 Plots", filename = "heat_deaths_id.png")
...
ggsave(path = "results/Phase 2 Plots", filename = "heat_transfusions_id.png")
...
ggsave(path = "results/Phase 2 Plots", filename = "heat_deaths_di.png")
...
ggsave(path = "results/Phase 2 Plots", filename = "heat_transfusions_di.png")
...
ggsave(path = "results/Phase 2 Plots", filename = "heat_deaths_dt.png")
...
ggsave(path = "results/Phase 2 Plots", filename = "heat_transfusions_dt.png")
...
ggsave(path = "results/Phase 2 Plots", filename = "heat_deaths_ds.png")
...
ggsave(path = "results/Phase 2 Plots", filename = "heat_transfusions_ds.png")
