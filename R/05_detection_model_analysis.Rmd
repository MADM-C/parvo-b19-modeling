...
plot(owsa_results$owsa_B19_Deaths,) +
  ...
  scale_color_discrete(labels = c("Status Quo", "Increased Detection")) +
  labs(colour = "Strategy") +
  theme_bw() +
  ...
  geom_vline (data = filter(owsa_test, parameter == "Detection Probability"), aes(xintercept = v_det), linetype = "dotted") 
