...
ggsave(path = "results/Phase 3 Plots", filename = "owsa_stillbirths.png")
...
ggsave(path = "results/Phase 3 Plots", filename = "owsa_b19deaths.png")
...
plot(owsa_results$owsa_Transfusions) +
  ...
  geom_vline(data = intercepts, aes(xintercept = xint), linetype = "dashed") +
  theme(legend.position = "bottom") 
ggsave(path = "results/Phase 3 Plots", filename = "owsa_transfusion.png")
...
ggplot(data = df_owsa_all, aes(x = param_val, y = outcome_val, color = strategy)) +
  ...
  geom_vline(data = intercepts, aes(xintercept = xint), linetype = "dashed") +
  theme(legend.position = "bottom") 
ggsave(path = "results/Phase 3 Plots", filename = "owsa_all.png")
```
...
heat_deaths_ii
ggsave(path = "results/Phase 3 Plots", filename = "twsa_imm_inf_deaths_sq_test.png",
       height = 7, width = 7)
...
heat_fd_ii
ggsave(path = "results/Phase 3 Plots", filename = "twsa_imm_inf_fd_sq_test.png",
       height = 7, width = 7)
...
ggsave(path = "results/Phase 3 Plots", filename = "twsa_imm_inf_trans_sq_test.png",
       height = 7, width = 7)
...
heat_deaths_ii
ggsave(path = "results/Phase 3 Plots", filename = "twsa_imm_inf_deaths_sq_vax.png",
       height = 7, width = 7)
...
heat_fd_ii
ggsave(path = "results/Phase 3 Plots", filename = "twsa_imm_inf_fd_sq_vax.png",
       height = 7, width = 7)
...
heat_transfusions_ii
ggsave(path = "results/Phase 3 Plots", filename = "twsa_imm_inf_trans_sq_vax.png",
       height = 7, width = 7)
...
heat_deaths_ii
ggsave(path = "results/Phase 3 Plots", filename = "twsa_imm_inf_deaths_sq_testvax.png",
       height = 7, width = 7)
...
heat_fd_ii
ggsave(path = "results/Phase 3 Plots", filename = "twsa_imm_inf_fd_sq_testvax.png",
       height = 7, width = 7)
...
heat_transfusions_ii
ggsave(path = "results/Phase 3 Plots", filename = "twsa_imm_inf_trans_sq_testvax.png",
       height = 7, width = 7)
...
ggsave(path = "results/Phase 3 Plots", filename = "twsa_optimal.png",
       height = 5, width = 9)
```
...
ggsave(path = "results/Phase 3 Plots", filename = "psa_optimal_sb.png",
       height = 5, width = 7)
