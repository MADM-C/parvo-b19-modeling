...
heat_fd_ii
ggsave(path = "Phase 3 Plots", filename = "twsa_imm_inf_fd_sq_test.png",
       height = 7, width = 7)
...
heat_fd_ii
ggsave(path = "Phase 3 Plots", filename = "twsa_imm_inf_fd_sq_vax.png",
       height = 7, width = 7)
...
heat_fd_ii
ggsave(path = "Phase 3 Plots", filename = "twsa_imm_inf_fd_sq_testvax.png",
       height = 7, width = 7)
